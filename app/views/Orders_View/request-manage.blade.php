...
<div class="container">
	<div class="page-header">
		<h1>Local Request <small>{{$user->name}}</small></h1>
	</div>
...
<div class="container" id="content">
	<form class="form-inline" role="form">
		<div class="row">
			<div class="col-sm-2">
				{{Former::select('status')->options(array('0'=>'on-process', '1'=>'compeleted'))->class('form-control')}}
			</div>
			<div class="col-sm-3">
...
<script>
	...
	$('#filter-button').click(function(){
		...
		if(from_date > to_date) alert('Wrong Input!!');
			...
			$.ajax({
				url: '{{asset("orders/request-manage")}}',
				type: 'POST',
