...
<div class="container hidden-print" id="content">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<button class="btn btn-default btn-block" id="report_print_button"><span class="glyphicon glyphicon-print"></span> Print Report</button>
						</div>
						<div class="col-sm-2">
							<button class="btn btn-success btn-block" data-toggle="modal" href='#validation-modal'>Equipments Calibration</button>
						</div>
					</div>
	...
	<form action="{{Asset('quality-control/inspection-table')}}" method="post" id="form-register">
		<div class="row">
			<div class="col-sm-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="row">
							...
							<div class="col-sm-1  form-group">
								...
								<div class="checkbox">
									<label>
										<input type="checkbox" value="1" name="quality">
										OK
									</label>
								</div>
							</div>
